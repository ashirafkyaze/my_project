import { View, Text, StyleSheet, Platform, ScrollView, Pressable, TextInput, Image } from "react-native"
    ...
    const fetchAddresses = async () => {
        try {
            const response = await axios.get(
                `http://192.168.8.104:8000/addresses/${userId}`
            );
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        {offers.map((item, index) => (
                            <Pressable
                                ...
                                <Image style={{ width: 150, height: 150, resizeMode: "contain" }} source={{ uri: item?.image }}></Image>
                                <View style={{
                                    backgroundColor: "#E31837", paddingVertical: 5, width: 130, justifyContent: "center", alignItems: "center", marginTop: 10, borderRadius:
                                        4
                                }}><Text style={{
                                    textAlign: "center",
                                    color: "white",
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        ...
                        <Pressable
                            ...
                            <Text style={{ textAlign: "center", color: "#0066b2", fontWeight: "500", }}>
                                Add an Address or pick-up pointt
                            </Text>
                        </Pressable>
                    </ScrollView>
