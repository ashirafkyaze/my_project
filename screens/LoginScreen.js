...
const LoginScreen = () => {
    ...
    const handleLogin = () => {
        ...
        axios
            .post("http://192.168.8.104:8081/login", user)
            .then((response) => {
                ...
                <View style={{ marginTop: 70 }}>
                    <View style={{
                        ...
                        <TextInput value={email}
                            onChangeText={(text) => setEmail(text)} style={{ color: "gray", marginVertical: 10, width: 300, fontSize: email ? 16 : 16, }} placeholder="Enter your Email" />
                    </View>
                </View>
